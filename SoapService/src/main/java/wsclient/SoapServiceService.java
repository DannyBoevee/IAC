 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://wsserver/", wsdlLocation = "http://localhost:1213/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://wsserver/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1213/hello?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://wsserver/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsserver/", "SoapServicePort"), SoapService.class, features);
    }
